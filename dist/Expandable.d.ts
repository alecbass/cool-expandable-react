...
export interface ExpandableProps extends Omit<DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>, "onToggle"> {
    /**
...
export declare const Expandable: ({ isOpen, shrunkHeight, expandedHeight, children, ...rest }: PropsWithChildren<ExpandableProps>) => ReactNode;
declare module "react" {
    namespace JSX {
        interface IntrinsicElements {
            "cool-expandable": React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & Partial<Record<ExpandableAttribute, string>>, HTMLElement>;
        }
    }
}
